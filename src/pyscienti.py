...
revistas = pd.read_excel(resource_path('./publindex.xlsx'), header = 0)
...
def _get_page(pagerequest):
    ...
    resp = _SESSION.get(pagerequest, verify=False)
